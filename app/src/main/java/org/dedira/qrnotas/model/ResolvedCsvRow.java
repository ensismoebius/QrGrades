 ...
 * (or, for a student, determined to need creating). This is the "ready to import" counterpart
 * of {@link CsvStudentRow}: instead of plain-text names, it carries the resolved database ids
 * needed to actually create the {@link Enrollment}.
 */
public class ResolvedCsvRow {
    ...
    public final String disciplineId; // Id of the Discipline matched from the CSV's discipline name.
    public final String classGroupId; // Id of the ClassGroup matched from the CSV's class-group name.
